            ...
            <div className="h-screen bg-farm dark:bg-night-farm">
                <div className="w-full h-full flex justify-center items-center">
                    <div className="bg-board h-full w-[80%] bg-no-repeat bg-contain flex justify-center items-center">
                        <p className="text-[#853605] font-pixelify text-justify w-[500px]">This page was created with the purpose of practicing the development of web pages using the Next.js framework, and as a big fan of Stardew Valley, I decided to practice and create something related to the game. Here you will be able to see the food recipes of the game and also links to recipes on how to recreate them in real life, the resource to check on each recipe was the Stardew Valley wiki page. If you have interest on knowing more about the game, the links to the wiki, official page and also download will be here too. Thanks for checking on the page and hope you appreciate the work!</p>
