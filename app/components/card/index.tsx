...
export default function Card ({ recipe }: CardProps) {
    ...
    return (
        <>
            <div key={recipe.id} className="bg-[#F2E7C4] dark:bg-[#853605] w-64 h-72 border-[#853605] dark:border-[#F2E7C4] border-8 flex flex-col justify-center items-center gap-4">
