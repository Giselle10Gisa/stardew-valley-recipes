...
export default function Footer () {
    ...
    return (
        <div className="bg-wood-footer bg-contain h-44 border-[#853605] border-[10px] flex justify-between px-4 items-center">
            ...
            <div className={`${pagesOptions === false ? 'hidden' : 'flex'} flex-row gap-10 bg-[#FFF3CC] px-2 border-[#853605] border-[5px] rounded-md`}>
            ...
            <div onClick={() => handleClick()} className="bg-[#FFF3CC] px-2 border-[#853605] border-[5px] rounded-md flex flex-row items-center gap-1 text-[#853605] font-pixelify shadow-xl cursor-pointer transition-transform duration-300 hover:border-[#FFF3CC] hover:bg-[#853605] hover:text-[#FFF3CC]">
